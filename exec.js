...
function getStation(lineCode) {
    const stationArray = line[lineCode].sta
    // const station = stationArray[0]
    // console.log(station.name)

    // console.log('Object.values', Object.values(line[lineCode].sta))
    // console.log('Array', line[lineCode].sta)

    stationArray.forEach((value, index) => {
        console.log(index, value.name) // value = object type
    })
}
getStation('SIL')